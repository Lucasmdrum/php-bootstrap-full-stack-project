...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">lnício</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="formacoes.php">formacoes</a>
          </li>
          <li class="nav-item">
...
<main>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <p>cadastro de suas formações</p>
        <p><a class="btn btn-secondary" href="#">cadastre formações &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg>
      ...
      <div class="col-lg-4">
        ...
        <p>faça suas configurações</p>
        <p><a class="btn btn-secondary" href="#"> configurações
           &raquo;</a></p>
  ...
  <footer class="container">
    <p class="float-end"><a href="#">r para o topo</a></p>
